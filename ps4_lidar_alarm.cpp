...
const double MIN_SAFE_DISTANCE = 2.0; // set alarm if anything is within 1.5m of the front of robot
...
//Client to publish to estop_service to brake mobot
ros::ServiceClient client; 
//Client to publish to clear_estop_service to clear estop of mobot
...
int main(int argc, char **argv) {
    ...
    client2 = nh.serviceClient<std_srvs::Trigger>("clear_estop_service");
